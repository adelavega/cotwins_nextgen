...
(function() {
  var Block, FeedbackTrial, IBI, ITI, Instruction, LivingKeyMap, PracFeedbackTrial, PracticeBlock, RTFeedbackBlock, SizeKeyMap, Slide1, Trial, blocks, c, clear_canvas, ctx, currSession, drawCircle, height, hideButtons, keyText, multilineText, red, trialLength, width,
  ...
  blocks = [new Slide1(instructions[0]), new common.FinishInstructions];
